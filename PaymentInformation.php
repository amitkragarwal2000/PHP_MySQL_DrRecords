<?php
	...
	if($_SESSION[User_type] == "Patient")
	{
		if ($_SERVER["REQUEST_METHOD"] == "POST")
		{
			...
			$query = "INSERT INTO Payment_Information(Card_number, CVV, Expiration_date, Cardholders_name, Type, Username) VALUES ('$_POST[cardnumber]', '$_POST[cvv]', '$_POST[expirationdate]','$_POST[cardholders_name]', '$_POST[cardtype]','$_SESSION[username]')";
