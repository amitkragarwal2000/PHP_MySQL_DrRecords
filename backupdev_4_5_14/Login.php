<?php
	...
	if($result[username] == '') 
	{
		header("Location: https://academic-php.cc.gatech.edu/groups/cs4400_Group_20/chad_dev/CreateProfile$_SESSION[User_type]");
	}
	else
	{
		header("Location: https://academic-php.cc.gatech.edu/groups/cs4400_Group_20/chad_dev/HomePage$_SESSION[User_type]");
	}
