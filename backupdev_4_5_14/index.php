		...
		if ($row['Password'] != "")
     	{
			...
			$_SESSION[password]=$row['Password'];
 	 	   	header("Location: https://academic-php.cc.gatech.edu/groups/cs4400_Group_20/chad_dev/Login");
		}
   	 	else
     	{
			$passwordErr = "Incorrect Username/Password";
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> 
   ...
   <br><br>
   <a href="https://academic-php.cc.gatech.edu/groups/cs4400_Group_20/chad_dev/CreateUser" target="_self">Create New User</a> 
